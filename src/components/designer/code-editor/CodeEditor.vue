        ...
        >
          ...
          >
            <div class="bg-black p-5">
              <XMarkIcon
                class="text-white w-6 absolute right-0 top-0 m-3 cursor-pointer"
                @click="cancelEditing()"
              />
              <prism-editor
                v-model="code"
              ...
              <div class="grid grid-cols-2 gap-4">
                <button
                  @click="editCode()"
                  class="text-white px-4 py-2 bg-green-500 rounded-lg w-full"
                >
                  Confirm Changes
                </button>
                <button
                  @click="cancelEditing()"
                  class="text-white px-4 py-2 bg-red-500 rounded-lg w-full"
                >
                  Discard Changes
                </button>
              </div>
