            ...
            <div class="my-2">
                <div class="flex flex-row justify-between mb-2">
                    <div class="flex flex-row gap-2 items-center">
                        <div
                            :class="['bg-' + colorRefs.bg.color, { 'border' : colorRefs.bg.color === 'white' || colorRefs.bg.transparent}]"
                    ...
                    <div class="flex flex-row gap-1 items-center">
                        ...
                        <div
                            @click="changeTransparency('bg'); colorRefs.bg.transparent = true"
                        ...
                        <div
                            @click="removeColor('bg'); colorRefs.bg.none = true"
                ...
                <div :class="[colorRefs.bg.open ? 'max-h-96' : 'max-h-0']"
                     class="flex flex-wrap gap-x-2 overflow-hidden duration-200">
          <span v-for="color in colors" :key="color" :class="'bg-' + color"
            ...
            <div class="mb-2">
                <div class="flex flex-row justify-between mb-2">
                    <div class="flex flex-row gap-2 items-center">
                        <div
                            :class="['bg-' + colorRefs.text.color, { 'border' : colorRefs.text.color === 'white' || colorRefs.text.transparent}]"
                            class="w-6 h-6 border-black rounded-md cursor-pointer"
                    ...
                    <div class="flex flex-row gap-1 items-center">
                        ...
                        <div
                            @click="changeTransparency('text'); colorRefs.text.transparent = true"
                        ...
                        <div
                            @click="removeColor('text'); colorRefs.text.none = true"
                ...
                <div :class="[colorRefs.text.open ? 'max-h-96' : 'max-h-0']"
                     class="flex flex-wrap gap-x-2 overflow-hidden duration-200">
          <span v-for="color in colors" :key="color" :class="'bg-' + color"
                class="inline-block w-5 h-5 my-1 rounded-md cursor-pointer duration-200 transform hover:scale-125"
...
import {XIcon, ColorSwatchIcon, CubeTransparentIcon} from '@heroicons/vue/outline';
...
watch(getCurrentElement, (newElement, oldElement) => {
    colorRefs.value.bg.color = colors.find(color => newElement.classList.contains(`bg-${color}`)) || '';
    colorRefs.value.bg.transparent = newElement.classList.contains('bg-transparent') ? true : false;
    colorRefs.value.bg.none = colorRefs.value.bg.color === '' && colorRefs.value.bg.transparent === false ? true : false;

    colorRefs.value.text.color = colors.find(color => newElement.classList.contains(`text-${color}`)) || '';
    colorRefs.value.text.transparent = newElement.classList.contains('text-transparent') ? true : false;
    colorRefs.value.text.none = colorRefs.value.text.color === '' && colorRefs.value.text.transparent === false ? true : false;
});
const colorRefs = ref({
    bg: {
        color: '',
