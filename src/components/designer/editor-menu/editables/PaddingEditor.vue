<template>
  <EditorAccordion>
    ...
    <template #content>
      <div class="my-2">
        <label for="y_axis" class="primaryDesignerLabel">
          Padding Y-axis:
        </label>

        <div>
          <select v-model="ySelected" @change="yPaddingChange" id="y_axis" class="primaryDesignerSelect">
            <option v-for="padding in TAILWIND_NUMBER_PROPERTIES" :key="padding">
              {{ padding }}
            </option>
          </select>
        </div>
      ...
      <div class="my-2">
        <label for="x_axis" class="primaryDesignerLabel">
          Padding X-axis:
        </label>
        <div>
          <select v-model="xSelected" @change="xPaddingChange" id="x_axis" class="primaryDesignerSelect">
            <option v-for="padding in TAILWIND_NUMBER_PROPERTIES" :key="padding">
              {{ padding }}
            </option>
          </select>
