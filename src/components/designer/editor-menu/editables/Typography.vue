        ...
        <template #content>
            <div class="mb-2">
                <label for="meta_title"
                       class="primaryDesignerLabel">
                    Font base size
                </label>
                <select v-model="fontRefs.size"
                        class="primaryDesignerSelect"
                        @change="changeFont('size')">
            ...
            <div class="mb-2">
                ...
                <select v-model="fontRefs.weight"
                        class="primaryDesignerSelect"
                        @change="changeFont('weight')">
                    <option disabled value="">Select</option>
            ...
            <div class="mb-4">
                ...
                <select v-model="fontRefs.family"
                        class="primaryDesignerSelect"
                        @change="changeFont('family')">
            ...
            <div class="mb-4">
                ...
                <select v-model="fontRefs.style"
                        class="primaryDesignerSelect"
                        @change="changeFont('style')">
                    <option class="rounded-xl" disabled value="">Select</option>
...
watch(getCurrentElement, (newElement, oldElement) => {
    fontRefs.value.size = fontAttributes.size.find(size => newElement.classList.contains(`text-${size}`)) || '';
    fontRefs.value.weight = fontAttributes.weight.find(weight => newElement.classList.contains(`font-${weight}`)) || '';
    fontRefs.value.family = fontAttributes.family.find(family => newElement.classList.contains(`font-${family}`)) || '';
    fontRefs.value.style = fontAttributes.style.find(style => newElement.classList.contains(style)) || '';
