            ...
            <form @submit.prevent="searchMedia">
                ...
                <div class="relative">
                    ...
                    <input
                        type="search"
                        id="default-search"
                        class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 focus:bg-white dark:bg-gray-700"
                        autocomplete="off"
...
// in store - update preview image
    store.commit('Designer/setCurrentPreview', "/storage/images/site-" + siteId.value + "/" + file.name);
};
