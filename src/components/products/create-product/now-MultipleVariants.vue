<template>
    <TransitionGroup name="fade">
        <div
            v-for="(optionWithValues, index) in dynamicOptionsWithValuesFields"
            :key="index">
            <div class="grid grid-cols-12 primary-gap mb-8 text-xs">
                <div class="col-span-4 self-start grid">
                    <label
                        :for="`options_values[${index}][option]`"
                        ...
                        <div v-for="(option, idx) in optionsWithValuesForConversion" :key="option"
                            ...
                            <ul v-if="option.optionId === optionWithValues.optionId"
                                ...
                                <input
                                    ...
                                    :name="`options_values[${index}][option]`"
                                    type="text"
                                    hidden/>
                                <input
                                    v-model="option.optionId"
                                    :name="`options_values[${index}][frontend_id]`"
                                    type="text"
                                    hidden/>
                                <input
                                    v-model="option.index"
                                    :name="`options_values[${index}][option_index]`"
                                    type="text"
                                    hidden/>
                                ...
                                <div class="tagifyInputWithIcon">
                                    <input
                                        ...
                                        @keydown.enter.tab.prevent="handleAddOption($event, optionWithValues.option, optionWithValues.optionId, index)"
                                        :id="`options_values[${index}][option]`"
                                        type="text"
                                        ref="refOptionInput"
                                        class="tagifyInput"
                                        placeholder="Color.."
                    ...
                    <div v-if="frontendOptionError.index === index">
                ...
                <div class="col-span-8 self-start grid">
                    <div>
                        <label
                            :for="`options_values[${index}][values]`"
                            class="tagifyLabel font-semibold">
                            Values
                        </label>


                        <!--test draggable - start hør-->
                        <div class="col-6">
                            <draggable
                                :list="list"
                                :dragging="dragging"
                                ...
                                <template #item="{ element }">
                                    <div class="list-group-item border-2 py-4 my-2 text-center text-white bg-gray-800"
                                         :class="{ 'not-draggable': !enabled }">
                                        ØØ se her: {{ element.name }}
                                    </div>
                                </template>
                                <!--iterate list - end-->
                            </draggable>
                                ...
                                <div>
                                    <div v-for="(option, idx) in optionsWithValuesForConversion" :key="idx"
                                        ...
                                        <ul v-if="option.optionId === optionWithValues.optionId"
                                            class="flex flex-wrap grow items-center gap-2">
                                            <TransitionGroup name="tags">
                                                <li v-for="(value, idxNumber) in option.values" :key="value"
                                                    class="tagifyTag"
                                                    @click="deleteEnteredValue(option.optionId, value.valueId)">

                                                    <!--value tags start-->
                                                    {{
                                                        value.nameValue.substring(0, 6)
                                                    }}{{ value.nameValue.length > 6 ? '...' : '' }}
                                                    <span>×</span>
                                                    <!--value tags end-->
                                                    ...
                                                    <input
                                                        ...
                                                        :name="`options_values[${index}][values][${idxNumber}][name_value]`"
                                                        type="text"
                                                        hidden/>

                                                    <input
                                                        v-model="value.valueId"
                                                        :name="`options_values[${index}][values][${idxNumber}][value_id]`"
                                                        type="text"
                                                        hidden/>
                                                    <input
                                                        v-model="value.valueIndex"
                                                        :name="`options_values[${index}][values][${idxNumber}][value_index]`"
                                                        type="text"
                                                        hidden/>
                                                    <input
                                                        v-model="value.optionId"
                                                        :name="`options_values[${index}][values][${idxNumber}][frontend_option_id]`"
                                                        type="text"
                                                        hidden/>
                                                    <input
                                                        v-model="value.frontendOptionIndex"
                                                        :name="`options_values[${index}][values][${idxNumber}][frontend_option_index]`"
                                                        type="text"
                                                        hidden/>
                                                    <!--hidden input fields - end-->
                                                </li>
                                            ...
                                            <div class="tagifyInputWithIcon min-w-[6rem]">
                                                <input v-model="optionWithValues.value"
                                                       @keydown.enter.tab.prevent="handleAddValue(optionWithValues.value, optionWithValues.optionId, index)"
                                                       :id="`options_values[${index}][values]`"
                                                       type="text"
                        ...
                        <div v-if="frontendValueError.index === index">
...
const draggingInfo = function () {
    return dragging.value ? "under drag" : "";
}

const checkMove = function () {
    return dragging.value ? "under drag øøøø" : "";
}
...
const deleteEnteredOptionWithValues = function (optionId) {
    ...
    thirdModalButtonFunction.value = function () {
        ...
        //
        //
        // // always re-add 1 "dynamic options with values" field, if user deletes the last one
        // setTimeout(() => {
        //     // always re-add 1 "dynamic options with values" field, if user deletes the last one
        //     if (dynamicOptionsWithValuesFields.value.length === 0 && getVariantType.value === 'multipleProduct') {
        //
        //         setTimeout(() => {
        //             OptionsWithValuesFrontendError.value = null
        //         }, 3000)
        ...
        //     }
        // }, 1000)
        // // end of re-add 1 "dynamic options with values" field, if user deletes the last one
...
const bulkEdit = function () {
    ...
    descriptionModal.value = 'Bulkt edit multiple selected variants.';
    firstButtonModal.value = 'Cancel';
    secondButtonModal.value = null;
